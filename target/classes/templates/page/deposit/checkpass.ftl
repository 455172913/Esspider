	...
	<div class="wrap clearfix">
		...
		<div class="content">
			...
			<ul class="pay-type">
				...
				<li><a href="/admin/settle/deposit/checkfail">审核未通过</a><div class="line-block">
			</ul>
...
<#-- 							<th>财务备注</th>
 -->						</tr>
				...
				<#-- 载入分页 -->
				<#include "/page/deposit/tpl/checkpass.ftl">
	...
	<script type="text/javascript">
	    require(['/js/page/deposit/checkby.js'], function(page){
	        page.init();
	    });
	</script>
</@html>
